/**
 * We need this because it's required by com.triposo.droidguide.util.AsyncTask
 * and java.util.ArrayDeque2 is available only since API Level 9.
 */
...
/**
 * Resizable-array implementation of the  interface.  Array
 ...
 *
 * <p>Most <tt>ArrayDeque2</tt> operations run in amortized constant time.
 ...
 */
public class ArrayDeque2<E> extends AbstractCollection<E>
    implements Deque<E>, Cloneable, Serializable
{
   ...
   */
  public ArrayDeque2(int numElements) {
   ...
   */
  public ArrayDeque2(Collection<? extends E> c) {
   ...
   */
  public ArrayDeque2<E> clone() {
    try {
      ArrayDeque2<E> result = (ArrayDeque2<E>) super.clone();
