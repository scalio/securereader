...
public class PanicActivity extends Activity implements OnTouchListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (info.guardianproject.zt.App.getSettings().wipeApp())
	...
	private void doWipe()
	{
		if (mOnlyTesting)
		{
			Builder alert = new Builder(this).setTitle(R.string.app_name)
		...
		{
			// Do the wipe
			info.guardianproject.zt.App.getInstance().wipe(info.guardianproject.zt.App.getSettings().wipeApp() ? SocialReader.FULL_APP_WIPE : SocialReader.DATA_WIPE);
