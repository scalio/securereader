...
import info.guardianproject.zt.adapters.PostDraftsListAdapter.PostDraftsListAdapterListener;
...
public class PostListFragment extends Fragment implements PostDraftsListAdapterListener
{
	...
	{
		socialReporter = ((info.guardianproject.zt.App) getActivity().getApplicationContext()).socialReporter;
	...
	public void updateListAdapter() {
		...
		info.guardianproject.zt.ThreadedTask<Void, Void, ArrayList<Item>> updateTask = new info.guardianproject.zt.ThreadedTask<Void, Void, ArrayList<Item>>(){
