...
public class SettingsActivity extends FragmentActivityWithMenu
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mSettings = info.guardianproject.zt.App.getSettings();
	...
	private void populateProfileTab()
	{
		...
		tabView.findViewById(R.id.btnSetLaunchPassphrase).setOnClickListener(new OnClickListener()
		{
			@Override
		...
		tabView.findViewById(R.id.btnSetKillPassphrase).setOnClickListener(new OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
...
//		}
	...
	private class RadioButtonChangeListener implements OnCheckedChangeListener
	{
	...
	private void promptForKillPassphrase(final boolean setToOnIfSuccessful)
	{
		...
		.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener()
		{
			...
			public void onClick(DialogInterface dialog, int which)
			{
				...
				// Store
				info.guardianproject.zt.App.getSettings().setKillPassphrase(editNewPassphrase.getText().toString());
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		if (mIsBeingRecreated)
		{
			...
			{
				if (info.guardianproject.zt.SettingsUI.KEY_ENABLE_SCREENSHOTS.equals(mLastChangedSetting))
				{
