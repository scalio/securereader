...
import info.guardianproject.zt.views.EPubMediaContentPreviewView;
import info.guardianproject.zt.views.ImageMediaContentPreviewView;
import info.guardianproject.zt.views.MediaContentPreviewView;
import info.guardianproject.zt.views.VideoMediaContentPreviewView;
...
public class MediaViewCollection 
{
	...
	public void onMediaAvailable(MediaContent content, int index, boolean wasCached, java.io.File mediaFileNonVFS, File mediaFile)
	{
		if (mHasBeenRecycled)
		{
			if (LOGGING)
