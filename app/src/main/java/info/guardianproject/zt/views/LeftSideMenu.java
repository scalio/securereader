...
public class LeftSideMenu
{
	...
	private View createMenuView()
	{
		if (mMenuView == null)
		{
			...
			LayoutParams laysRoot = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT,
			...
			LayoutParams lays = (LayoutParams) mMenuView.getLayoutParams();
	...
	{
		getActionBarSizes();
		LayoutParams laysRoot = (LayoutParams) mRoot.getLayoutParams();
		laysRoot.setMargins(0, mStatusBarHeight, 0, 0);
		mRoot.setLayoutParams(laysRoot);
		...
		LayoutParams lpContent = (LayoutParams) mContent.getLayoutParams();
		lpContent.setMargins(0, -mStatusBarHeight, 0, 0);
		mContent.setLayoutParams(lpContent);
	}
