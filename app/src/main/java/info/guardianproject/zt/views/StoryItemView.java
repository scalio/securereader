...
import info.guardianproject.zt.widgets.AnimatedRelativeLayout;
import info.guardianproject.zt.widgets.CustomFontTextView;
import info.guardianproject.zt.widgets.HeightLimitedRelativeLayout;
...
public class StoryItemView implements PagedViewContent, OnUpdateListener, OnMediaLoadedListener
{
	...
	private class ReadMoreClickListener implements OnClickListener
	{
		private final Item mItem;
