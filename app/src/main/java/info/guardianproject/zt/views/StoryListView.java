...
import info.guardianproject.zt.widgets.AppearingFrameLayout;
import info.guardianproject.zt.widgets.AppearingRelativeLayout;
import info.guardianproject.zt.widgets.HeightLimitedLinearLayout;
import info.guardianproject.zt.widgets.SyncableListView;
import info.guardianproject.zt.widgets.SyncableListView.OnPullDownListener;
...
public class StoryListView extends RelativeLayout implements OnTagClickedListener, OnPullDownListener, OnHeaderCreatedListener 
{
	...
	private void init()
	{
		...
		mListStories.setOnScrollListener(new OnScrollListener()
		{
