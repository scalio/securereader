...
public class GroupView extends LinearLayout
{
	...
	public void expand(boolean animated)
	{
		...
		if (animated)
		{
			...
			if (width > 0)
			{
				super.measure(MeasureSpec.makeMeasureSpec(getWidth(), MeasureSpec.EXACTLY), MeasureSpec.UNSPECIFIED);
	...
	private int getCollapsedHeight()
	{
		...
		if (mHeaderView != null)
		{
			mHeaderView.measure(MeasureSpec.makeMeasureSpec(getWidth(), MeasureSpec.EXACTLY), MeasureSpec.UNSPECIFIED);
