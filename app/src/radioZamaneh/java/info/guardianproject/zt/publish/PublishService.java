...
public class PublishService extends IntentService implements PublishController.PublishListener {
    ...
    public static final String ACTION_RENDER = "info.guardianproject.zt.publish.action.RENDER";
    public static final String ACTION_UPLOAD = "info.guardianproject.zt.publish.action.UPLOAD";
    public static final String ACTION_PUBLISH_SUCCESS = "info.guardianproject.zt.publish.action.PUBLISH_SUCCESS";
    public static final String ACTION_PUBLISH_FAILURE = "info.guardianproject.zt.publish.action.PUBLISH_FAILURE";
    public static final String ACTION_JOB_SUCCESS = "info.guardianproject.zt.publish.action.JOB_SUCCESS";
    public static final String ACTION_JOB_FAILURE = "info.guardianproject.zt.publish.action.JOB_FAILURE";
    public static final String ACTION_PROGRESS = "info.guardianproject.zt.publish.action.PROGRESS";
