...
import info.guardianproject.zt.publish.PublishController;
import net.sqlcipher.database.SQLiteDatabase;

import java.util.Date;

import info.guardianproject.zt.publish.PublisherBase;
import info.guardianproject.zt.publish.db.StoryMakerDB;
...
public class Job extends Model {
    ...
    public Job(Context context, int id, int publishJobId, String type,
    ...
    public Job(SQLiteDatabase db, Context context, int id, int publishJobId, String type,
			String site, String spec, String result, int errorCode,
			String errorMessage, Date queuedAt, Date finishedAt) {
		super(db, context);
		this.id = id;
    ...
    public Job(Context context, int id, int publishJobId, String type, String site, String spec) {
		super(context);
		this.id = id;
		this.publishJobId = publishJobId;
		this.type = type;
    ...
    public Job(SQLiteDatabase db, Context context, int id, int publishJobId, String type, String site, String spec) {
		super(db, context);
		this.id = id;
		this.publishJobId = publishJobId;
		this.type = type;
    ...
    public Job(Context context, int publishJobId, String type,
            String site, String spec, String result, int errorCode,
            String errorMessage, Date queuedAt, Date finishedAt) {
        super(context);
        this.publishJobId = publishJobId;
    ...
    public Job(SQLiteDatabase db, Context context, int publishJobId, String type,
            String site, String spec, String result, int errorCode,
            String errorMessage, Date queuedAt, Date finishedAt) {
        super(db, context);
        this.publishJobId = publishJobId;
    ...
    public Job(Context context, int publishJobId, String type, String site, String spec) {
        super(context);
        this.publishJobId = publishJobId;
        this.type = type;
        this.site = site;
    ...
    public Job(SQLiteDatabase db, Context context, int publishJobId, String type, String site, String spec) {
        super(db, context);
        this.publishJobId = publishJobId;
        this.type = type;
        this.site = site;
