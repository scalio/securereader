/**
 * An async task which runs in parallel with other async tasks.
 *
 * We need this because starting HONEYCOMB, tasks are back to being
 * executed on a single thread by default.
 */
/*
...
public abstract class AsyncTask<Params, Progress, Result> {
  private static final String LOG_TAG = "SnappyAsyncTask";
  ...
  private static final ThreadFactory sThreadFactory = new ThreadFactory() {
    ...
    public Thread newThread(Runnable r) {
      return new Thread(r, "SnappyAsyncTask #" + mCount.getAndIncrement());
    }
  };
  ...
  private static class SerialExecutor implements Executor {
    final ArrayDeque2<Runnable> mTasks = new ArrayDeque2<Runnable>();
    Runnable mActive;
