...
public class UploadsChooseActivity extends FragmentActivityWithMenu {
	...
	private void handleTextCapture() {
		Intent uploadsActivityIntent = new Intent(this, info.guardianproject.zt.UploadsActivity.class);
    ...
    protected void onUnlockedActivityResult(int requestCode, int resultCode, Intent intent) {
